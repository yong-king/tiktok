...
import (
	...
	"feed-service/internal/data/model"
)
...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Reserved1 = field.NewString(tableName, "reserved1")
	_user.Reserved2 = field.NewString(tableName, "reserved2")
...
type user struct {
	...
	Tags            field.String // AI
	Status          field.Int32  // 10
	Extra           field.String
...
func (u *user) updateTableName(table string) *user {
	...
	u.Reserved1 = field.NewString(table, "reserved1")
	u.Reserved2 = field.NewString(table, "reserved2")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["reserved1"] = u.Reserved1
	u.fieldMap["reserved2"] = u.Reserved2
